...
class AuthService:
    ...
    async def signup(self, data: SignupRequest) -> User:
        ...
        user_in = {
            ...
            "role": UserRole.EMPLOYEE # Always employee at signup
        }
    ...
    async def forgot_password(self, email: str) -> str:
        ...
        if not user:
            ...
            # But for hackathon, let's return a valid one for simplicity if they exist.
            raise NotFoundException("User not found")
        
        # In a real app we'd save this to DB and send an email
        reset_token = create_access_token(subject=user.id, role="reset", expires_delta=None) # short lived
        return reset_token
